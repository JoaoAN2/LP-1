...
public class DateTools {
    ...
    SimpleDateFormat SDF_A = new SimpleDateFormat("HH:mm");
    ...
    public String conversionDateAndHoursToString(Date date, String msg) {
        try {
            return SDF.format(date) + msg + SDF_A.format(date);
        } catch (Exception e) {
            return null;
        }
    }
